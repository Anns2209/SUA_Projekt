// Modul za pošiljanje logov v RabbitMQ. Isti vzorec v vsaki Node.js storitvi,
// spremeni se samo SERVICE_NAME (okoljska spremenljivka).
...
const SERVICE_NAME = process.env.SERVICE_NAME || 'static-menu-service';
...
async function publishLog(level, url, correlationId, message) {
  ...
  try {
    ...
    // Napaka pri logiranju NE sme podreti glavne poslovne logike
